...
function getUsageResource(): string {
  return [
    ...
    '',
    '- Use `plan_metro_north_trip` first for station-to-station questions; it returns direct trains plus one-transfer itineraries via guaranteed connections at hub stations (best for branch stations like New Canaan, Danbury, and Waterbury).',
    ...
    '- Only direct and one-transfer trips are supported; itineraries needing two or more transfers are not.',
    '',
    '## Station matching',
    '',
    ...
    '2. Call `plan_metro_north_trip` for recommended options (direct trains, plus one-transfer itineraries when direct service is thin or absent).',
